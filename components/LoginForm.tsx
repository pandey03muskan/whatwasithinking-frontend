  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-brown-950/10 p-8">
        <h2 className="text-base font-semibold text-brown-950 mb-6">Sign in to continue</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading
              ? <><Icon icon="ph:circle-notch" className="animate-spin text-base" /> Signing in...</>
              : <><Icon icon="ph:sign-in" className="text-base" /> Sign in</>
            }
          </button>
        </form>
        ...
        <p className="text-sm text-brown-950/50 text-center mt-6">
          No account?{' '}
          <Link href="/register" className="text-brown-950 font-medium hover:underline">
            Create one
          </Link>
        </p>
      </div>
